...
function ValueProp({ icon, title, description, gradient }: {
    ...
    return (
        <div className="relative group h-full">
            ...
            <div className="relative p-8 rounded-2xl bg-white dark:bg-white/5 border border-border/50 dark:border-white/10 backdrop-blur-sm hover:border-border dark:hover:border-white/20 transition-colors h-full flex flex-col shadow-sm dark:shadow-none">
